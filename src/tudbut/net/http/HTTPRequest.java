...
public class HTTPRequest {
    ...
    public HTTPRequest(@NotNull HTTPRequestType requestType, String host, int port, String path, HTTPHeader... headers) {
        this(requestType, host, port, path, null, "", headers);
    }

    public HTTPRequest(@NotNull HTTPRequestType requestTypeIn, String hostIn, int portIn, String pathIn, HTTPContentType type, @NotNull String contentIn, HTTPHeader... headersIn) {
    ...
    public Partial<HTTPResponse> sendKeepAlive() throws IOException {
        ...
        AsyncTask<Nothing> task = new AsyncTask<>(backValue -> {
            Thread.sleep(100);
